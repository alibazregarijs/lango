...
export default function SignInPage() {
  return (
    <div className="grid w-full grow justify-center h-full pattern items-center px-4 sm:justify-center">
      <SignIn.Root>
        <Clerk.Loading>
          {(isGlobalLoading) => (
            <>
              <SignIn.Step name="start">
                <Card className="w-full sm:w-96 bg-dark-100">
                  <CardHeader>
                    <CardTitle>Sign in to <span className="text-orange-1">Lango</span></CardTitle>
                    <CardDescription>
